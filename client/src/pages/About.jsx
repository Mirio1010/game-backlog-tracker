    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-surface to-background text-foreground">
      ...
      <main className="relative overflow-hidden">
        ...
        <section className="relative mx-auto max-w-5xl px-4 pb-16 sm:px-6 sm:pb-20">
          <div className="rounded-3xl border border-border bg-card p-5 shadow-2xl shadow-black/40 backdrop-blur-xl sm:p-8 md:p-10">
...
const AboutCard = ({ icon, title, description }) => {
  return (
    <div className="rounded-3xl border border-border bg-card p-5 backdrop-blur transition hover:border-primary/30 hover:bg-white/10 sm:p-6">
